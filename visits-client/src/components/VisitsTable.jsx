...
export default function VisitTable(props) {
        return (
            ...
            <tr className="bg-gray-600 text-gray-50">
                ...
                <th className="text-center px-4 py-2">Personne rencontrée 1</th>
                <th className="text-center px-4 py-2">Personne rencontrée 2</th>
                <th className="text-center px-4 py-2">Personne rencontrée 3</th>
