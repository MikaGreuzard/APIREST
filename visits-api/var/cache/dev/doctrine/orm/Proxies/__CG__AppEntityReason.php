 ...
 */
class Reason extends \App\Entity\Reason implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'reasonName' => [parent::class, 'reasonName', null],
        "\0".parent::class."\0".'visits' => [parent::class, 'visits', null],
        'id' => [parent::class, 'id', null],
        'reasonName' => [parent::class, 'reasonName', null],
